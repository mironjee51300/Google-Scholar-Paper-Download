To help others understand and use **Scholar PDF Downloader**, a strong GitHub README should be clear, professional, and explain exactly how to get the program running on a Windows laptop. 
...
**Type:** pip install scholarly requests beautifulsoup4

# How to Use

1.  **Run the Script:** Type scholar_downloader.py` in Command Prompt file to open the window.
2.  **Enter Topic:** Type your research topic (e.g., "Machine Learning in Healthcare").
3.  **Set Years:** Define the publication range (e.g., From Year To Year).
